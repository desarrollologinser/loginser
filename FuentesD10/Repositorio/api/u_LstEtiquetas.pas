...
procedure TDMLstEtiquetas.GeneraBodyUna(tipo,albaran:string);
var
  jsalbaran:TJSONObject;
  jsalbaranes:TJSONArray;
begin
...
procedure TDMLstEtiquetas.ObtenEtiquetas(tipo,albaran:string;una:Boolean=False);
var
  i,estado:integer;
...
Procedure TDMLstEtiquetas.ImprimeEtiqueta(url,tipo:string);
var
  MS1: TMemoryStream;
  fichero:string;
  IdHTTP1: TIdHTTP;
...
procedure TDMLstEtiquetas.ImprimePdf(fichero:string);
var
  indice:integer;
...
function TDMLstEtiquetas.CreateTempFile(prefijo:string): string;
