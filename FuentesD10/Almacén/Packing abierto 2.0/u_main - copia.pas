           ...
           { if cdsreparto.Locate('codalbaran',FieldByName('codalbaran').AsString,[]) then
            begin
                ...
                cdsreparto.Post;
                    ...
                    if tipo='I' then   //solo se dice el reparto de viva voz si se está insertando
                    begin
                      if FileExists(ruta_exe+'Audio\'+inttostr(u_globals.voice_id)+'-C.wav') then
                          sndPlaySound(PChar(ruta_exe+'Audio\'+inttostr(u_globals.voice_id)+'-C.wav'),SND_NODEFAULT Or SND_ASYNC);
    ...
    try
        ...
        begin
            ...
            begin
              ...
              asunto := 'Confirmación de envío. Pedido ' + mail_nombre_cli + ' ' + FieldByName('ref_cliente').AsString;
              ...
              cuerpo.Add(
                        ...
                        '</tr>' +
                        '<tr>' +
                         '<td><br>Tu pedido de ' + mail_nombre_cli + ' <b>' + FieldByName('ref_cliente').AsString + '</b> ya está de camino a la siguiente dirección:</td>' +
                        '</tr>' +
                        '<tr>' +
                        ...
                        '</tr>' +
                        '<tr>' +
                         '<td><br>Este es tu número de seguimiento para saber en todo momento donde está tu pedido. Se ha enviado por medio de ' +
                        ...
                        '</tr>' +
                        '<tr>' +
                          '<td><br>Si tienes cualquier duda escribe un email a ' + mail_mail_info + ' y desde atención al cliente te atenderán.<br><br> ' +
