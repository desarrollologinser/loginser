...
begin
  ...
  try
    ...
    f_main.mm.Lines.Add(FormatDateTime('hh:mm',now)+ ' ' + 'Clientes OK');

  except
         on e:Exception do begin
          dm.t_write.Rollback;
          f_main.mm.Lines.Add('Error: '+e.Message);
          f_main.mm.Lines.Add(FormatDateTime('hh:mm',now)+ ' ' + 'Clientes ERROR');
        end;
  end;
